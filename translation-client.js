(() => {
  ...
  const dictionary = new Map(Object.entries({
    ...
    'Messages':'الرسائل','Courses':'الدورات','Profile':'الملف الشخصي','Settings':'الإعدادات','Apply for work':'التقديم للعمل','Scholarships':'المنح الدراسية','Volunteer':'التطوع','Support Dafatii':'دعم دفاتري','Workspace':'مساحة العمل','Account & preferences':'الحساب والتفضيلات','Appearance':'المظهر','Language':'اللغة','Light mode':'الوضع الفاتح','Dark mode':'الوضع الداكن','Arabic':'العربية','Sign out':'تسجيل الخروج','Your account':'حسابك','Active course':'الدورة النشطة','Recent courses':'أحدث الدورات','See all courses':'عرض جميع الدورات','See full profile':'عرض الملف الشخصي كاملاً','Email':'البريد الإلكتروني','Study stage':'المرحلة الدراسية','School':'المدرسة','University':'الجامعة','Independent':'مستقل','Focus':'التركيز','Degrees':'الدرجات','Apply':'تقديم','Confirm':'تأكيد','Continue':'متابعة','Edit profile':'تعديل الملف الشخصي','Change course':'تغيير الدورة','Loading…':'جارٍ التحميل…','Required':'مطلوب',
    'Home':'الرئيسية','About':'حول','Features':'المزايا','Contact':'تواصل معنا','Start studying':'ابدأ الدراسة','Explore features':'استكشف المزايا','Your study life in one place':'حياتك الدراسية في مكان واحد','Study less. Learn more.':'ادرس بذكاء أكثر. تعلّم أكثر.','One space for every course':'مساحة واحدة لكل دورة','Built for focus, not clutter':'مصمم للتركيز بلا فوضى'
  }));
  ...
  const userContentSelector = [
    ...
    '.member-who','.admin-row>div','.quiet-profile-summary strong','.quiet-course-list strong',
    '.course-card h2','.course-card p','[data-user-content]','[data-no-translate]'
  ].join(',');
