(() => {
  ...
  async function upload(file, options = {}) {
    ...
    const initialized = await window.DafatiiApi.request('/files/upload-init', { method: 'POST', body: { filename: file.name, contentType, size: file.size, courseId: options.courseId || null, purpose: options.purpose || null } });
