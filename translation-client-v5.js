(() => {
  ...
  const userContent = [
    ...
    '.quiet-profile-summary strong','.quiet-course-list strong',
    ...
    '.course-card h2','.course-card p','.cal-cell.filled strong','.cal-cell.filled span',
