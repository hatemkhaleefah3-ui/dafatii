(() => {
  ...
  const paths = {
    ...
    'change-dafaa':'M3 7 12 3l9 4-9 4zM6 10v7l6 4 6-4v-7', profile:'M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8M4 22v-2a8 8 0 0 1 16 0v2',
  ...
  const bottomIcons = Object.freeze({...mainNavIcons,'change-dafaa':'change-dafaa',profile:'profile',settings:'settings'});
  ...
  function enhance(){
    ...
    const primary=full?['dashboard','subjects','calendar','study-rooms','chat']:['dashboard','change-dafaa','profile','settings'];
    ...
    const account=full?['change-dafaa','profile','settings']:[];
