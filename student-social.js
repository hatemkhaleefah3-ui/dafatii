(() => {
  ...
  function read(key,fallback){ return window.DafatiiDafat.readJSON(key,fallback); }
  function write(key,value){ return window.DafatiiDafat.writeJSON(key,value); }
  ...
  function allRooms(){ return [...window.DafatiiDafat.roomSeeds(),...roomState().customRooms]; }
  function chatState(){
