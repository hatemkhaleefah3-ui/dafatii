...
assert.ok(ui.includes("const hasDateRails=['tasks','schedule','todos','goals'].includes(plannerTab)") && ui.includes('data-planner-loop="mode"') && ui.includes('data-planner-loop="period"'), 'Tasks, Schedule, To-do and Goals must all keep the same two date picker rails');
