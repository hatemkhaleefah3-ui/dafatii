...
assert.ok(index.includes('calendar.js?v=20260919-16') && index.includes('calendar.css?v=20260919-13'), 'schedule redesign assets must be cache-busted');
