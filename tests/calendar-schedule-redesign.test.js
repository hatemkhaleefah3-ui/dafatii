...
assert.ok(ui.includes("const LEGACY_PLANNER_KEY = 'dafatii:schedulePlanner:v1'") && ui.includes("const PLANNER_KEY = 'dafatii:schedulePlanner:v2'") && course.includes("'dafatii:schedulePlanner:v2'"), 'planner must migrate v1 data into a canonical v2 store scoped to the active course');
