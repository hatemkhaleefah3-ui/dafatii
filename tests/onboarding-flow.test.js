...
assert.ok(index.includes('onboarding-flow.js?v=20260918-3') && index.includes('onboarding-flow.css?v=20260918-1') && !index.includes('pre-course.css'), 'only the new full-screen onboarding assets should be active');
