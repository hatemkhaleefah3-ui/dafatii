...
assert.ok(index.includes('content-controls.css?v=20260919-2') && index.includes('content-controls.js?v=20260919-2'), 'unified content control assets must load');
assert.ok(index.indexOf('content-controls.js?v=20260919-2') > index.indexOf('admin-console.js?v=20260918-4'), 'content controller must load after feature modules so it can centralize their actions');
