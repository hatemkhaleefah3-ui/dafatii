...
assert.ok(index.includes('study-structure.css?v=20260917-1') && index.includes('study-structure.js?v=20260917-2'), 'study structure assets must be loaded with the new cache version');
