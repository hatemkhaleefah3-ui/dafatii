...
assert.match(index, /calendar\.js\?v=20260919-15/, 'the cleaned calendar interface must be loaded');
assert.match(index, /calendar\.css\?v=20260919-11/, 'retired calendar toolbar styling must be removed from the active asset');
