...
assert.match(index, /student-social\.css\?v=20260919-3/, 'the multi-page chat application stylesheet must be loaded');
assert.match(index, /student-social\.js\?v=20260919-1/, 'the multi-page chat application controller must be loaded');
assert.match(index, /advanced-chat\.js\?v=20260919-2/, 'the advanced chat engine must load the multi-page integration build');
assert.match(index, /advanced-chat\.css\?v=20260919-3/, 'the advanced chat engine must load its dedicated shell integration styles');
