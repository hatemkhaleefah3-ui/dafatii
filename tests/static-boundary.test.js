...
assert.match(index, /quiet-design\.css\?v=20260917-dafaa1/, 'the consolidated presentation layer must be loaded');
assert.match(index, /device-layout\.js\?v=2/, 'device-aware navigation classification must load before rendering');
assert.match(index, /icon-system\.js\?v=20260917-dafaa1/, 'the unified icon system must load before the interface');
assert.match(index, /card-swipe\.js\?v=1/, 'the safe card gesture controller must be loaded');
assert.match(index, /quiet-shell\.js\?v=20260917-dafaa1/, 'the consolidated responsive shell must be loaded');
assert.match(index, /translation-client\.js\?v=1/, 'the authenticated interface translator must be loaded');
assert.match(index, /app\.js\?v=20260917-dafaa1/, 'the cleaned subject interface must be loaded');
assert.match(index, /calendar\.js\?v=20260917-dafaa1/, 'the cleaned calendar interface must be loaded');
assert.match(index, /calendar\.css\?v=20260915-4/, 'retired calendar toolbar styling must be removed from the active asset');
assert.match(index, /role-panels\.js\?v=20260917-dafaa1/, 'the redesigned dashboard management entry must be loaded');
assert.match(index, /role-panels\.css\?v=20260917-dafaa1/, 'the redesigned management entry styling must be loaded');
