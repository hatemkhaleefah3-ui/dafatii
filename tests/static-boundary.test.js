...
assert.match(index, /content-controls\.css\?v=20260920-1/, 'the unified content control presentation must be loaded');
assert.match(index, /content-controls\.js\?v=20260920-2/, 'the unified content control controller must be loaded');
