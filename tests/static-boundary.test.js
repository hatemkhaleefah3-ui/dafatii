...
assert.match(index, /content-controls\.js\?v=20260919-10/, 'the unified content control controller must be loaded');
...
assert.ok(lectureMediaCss.includes('Lecture study tools v3') && lectureMediaCss.includes('.flashcard-stage') && lectureMediaCss.includes('.mcq-exam-card') && lectureMediaCss.includes('.qa-exam-card') && lectureMediaCss.includes('.lecture-study-manager'), 'the three study pages and their manager must have dedicated responsive styling');
