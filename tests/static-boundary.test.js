...
assert.match(index, /content-controls\.css\?v=20260921-4/, 'the unified content control presentation must be loaded');
assert.match(index, /content-controls\.js\?v=20260921-2/, 'the unified content control controller must be loaded');
