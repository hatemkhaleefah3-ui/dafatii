...
assert.match(index, /quiet-design\.css\?v=2/, 'the consolidated presentation layer must be loaded');
assert.match(index, /quiet-shell\.js\?v=2/, 'the consolidated responsive shell must be loaded');
