...
assert.match(index, /calendar\.js\?v=20260918-1/, 'the cleaned calendar interface must be loaded');
assert.match(index, /calendar\.css\?v=20260918-1/, 'retired calendar toolbar styling must be removed from the active asset');
