...
assert.ok(lectureMedia.includes('Lecture study tools v2') && lectureMedia.includes("flashcards:{") && lectureMedia.includes("mcqs:{") && lectureMedia.includes("qa:{"), 'lectures must expose dedicated Flashcards, MCQ and Question & Answer modules');
...
assert.ok(index.includes('lecture-media.js?v=20260919-3') && index.includes('lecture-media.css?v=20260919-4'), 'lecture study assets must be cache-busted');
