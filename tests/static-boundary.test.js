...
assert.match(index, /content-controls\.css\?v=20260919-1/, 'the unified content control presentation must be loaded');
assert.match(index, /content-controls\.js\?v=20260919-1/, 'the unified content control controller must be loaded');
...
assert.match(index, /student-social\.js\?v=20260919-1/, 'the multi-page chat application controller must be loaded');
