...
assert.ok(index.includes('student-social.js?v=20260919-1') && index.includes('student-social.css?v=20260919-2'), 'chat app shell assets must be cache-busted');
assert.ok(index.includes('advanced-chat.js?v=20260919-1') && index.includes('advanced-chat.css?v=20260919-2'), 'advanced chat integration assets must be cache-busted');
...
assert.ok(advancedCss.includes('position:fixed;inset-inline:0;bottom:0;z-index:90') && advancedCss.includes('scroll-padding-bottom:calc(112px + env(safe-area-inset-bottom))'), 'open-thread composer must stay fixed to the viewport bottom without covering the final messages');
