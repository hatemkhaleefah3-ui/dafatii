...
assert.ok(advancedCss.includes('.chat-app-page.thread-open .chatpro-messages{grid-row:4}') && advancedCss.includes('.chat-app-page.thread-open .chatpro-composer-zone,') && advancedCss.includes('grid-row:5'), 'messages must own the flexible row and the composer must remain the final bottom row even when pinned/search rows are absent');
