...
assert.ok(index.includes('advanced-chat.js?v=20260919-1') && index.includes('advanced-chat.css?v=20260919-1'), 'advanced chat integration assets must be cache-busted');
