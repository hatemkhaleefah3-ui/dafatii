...
assert.doesNotMatch(courseLibrarySource, /dafatii:language-content:v1/, 'retired language content must not be accepted by the course backend');
assert.match(courseLibrarySource, /dafatii:language-learning:v1/, 'language learning v1 must be accepted by the course backend');
