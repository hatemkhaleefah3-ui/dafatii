(() => {
  ...
  function languageContent(page){
    return '<section class="language-empty-page" data-language-empty-page="'+esc(page)+'" aria-label="'+esc(t((navSpec.find(item=>item[0]===page)||navSpec[0])[2]))+'"></section>';
  }
  ...
  const navSpec=[
    ['language-home','nav-home','home'],
    ['language-letters','file','letters'],
    ['language-voice','nav-messages','voice'],
    ['language-grammar','star','grammar'],
    ['language-video','play','video'],
    ['language-examine','check','examine']
  ];
