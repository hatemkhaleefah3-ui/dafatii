(() => {
  ...
  const LANGUAGE_ITEM_TYPES=Object.freeze({
    'language-letters':[
      {id:'word-reveal',label:'Word reveal',feature:'reveal',title:'Meet a new word',body:'Tap to reveal the meaning of “hello”.',answer:'A friendly greeting.',hint:'Use the word in a short greeting.'},
      {id:'flip-card',label:'Flip card',feature:'flip',title:'Flip the word',body:'Front: book',answer:'A group of written or printed pages.',hint:'Tap the card to switch sides.'},
      {id:'spelling-check',label:'Spelling check',feature:'input',title:'Spell the word',body:'Type the word: language',answer:'language',hint:'Listen to the letters in your head, then type.'},
      {id:'missing-letter',label:'Missing letter',feature:'gap',title:'Complete the word',body:'Complete: st_dent',answer:'u',hint:'One letter is missing.'},
      {id:'meaning-choice',label:'Meaning choice',feature:'choice',title:'Choose the meaning',body:'What does “teacher” mean?',options:['A person who teaches','A place to sleep','A type of food'],answer:'A person who teaches',hint:'Pick one answer.'},
      {id:'sentence-builder',label:'Sentence builder',feature:'order',title:'Build the sentence',body:'Put the words in a natural order.',options:['I','study','every','day'],answer:'I study every day',hint:'Tap tokens in order.'},
      {id:'writing-prompt',label:'Writing prompt',feature:'write',title:'Write one sentence',body:'Write one sentence about your day using today’s vocabulary.',answer:'',hint:'Your response is saved on this device.'},
      {id:'word-sequence',label:'Word sequence',feature:'sequence',title:'Explore a word family',body:'Reveal related words one by one.',options:['learn','learner','learning'],answer:'learning',hint:'Move through the family.'},
      {id:'word-compare',label:'Word compare',feature:'compare',title:'Compare two words',body:'Compare “say” and “tell”.',options:['say','tell'],answer:'Use “say” for words; use “tell” when naming the listener.',hint:'Notice how the sentence changes.'},
      {id:'usage-self-check',label:'Usage self-check',feature:'selfcheck',title:'Use it naturally',body:'Write or say a sentence with “because”, then compare with the model.',answer:'I stayed home because it was raining.',hint:'Check meaning and word order.'}
    ],
    'language-voice':[
      {id:'audio-focus',label:'Audio focus',feature:'reveal',title:'Listen for one phrase',body:'Play the audio, then reveal the listening target.',answer:'Focus on the key phrase and its rhythm.',hint:'Add an audio URL in Edit content.',mediaUrl:''},
      {id:'listen-choice',label:'Listen & choose',feature:'choice',title:'Choose what you hear',body:'Play the audio and choose the closest phrase.',options:['How are you?','Where are you?','Who are you?'],answer:'How are you?',hint:'Replay before choosing.',mediaUrl:''},
      {id:'shadow-steps',label:'Shadowing steps',feature:'sequence',title:'Shadow the phrase',body:'Repeat each chunk immediately after hearing it.',options:['Good morning','How are you','today?'],answer:'Good morning How are you today?',hint:'Reveal one chunk at a time.',mediaUrl:''},
      {id:'speaking-timer',label:'Speaking timer',feature:'timer',title:'Speak for 20 seconds',body:'Talk about your morning without stopping.',answer:'20',hint:'Use simple sentences. Keep going.'},
      {id:'dialogue-turn',label:'Dialogue turn',feature:'dialogue',title:'Take your turn',body:'Partner: “What do you like to study?”',answer:'I like to study languages.',hint:'Answer first, then reveal the model turn.'},
      {id:'stress-compare',label:'Stress compare',feature:'compare',title:'Notice the stronger part',body:'Compare the two stress patterns.',options:['PREsent','preSENT'],answer:'The correct stress depends on how the word is used.',hint:'Say both versions aloud.'},
      {id:'sound-selection',label:'Sound selection',feature:'multi',title:'Select the sounds',body:'Select the words that contain the target sound.',options:['ship','sheep','shop','cat'],answer:'ship|shop',hint:'Choose every matching option.'},
      {id:'listening-order',label:'Listening order',feature:'order',title:'Order the heard chunks',body:'Put the chunks in the order you hear them.',options:['Nice','to','meet','you'],answer:'Nice to meet you',hint:'Replay and rebuild the phrase.',mediaUrl:''},
      {id:'speaking-note',label:'Speaking note',feature:'write',title:'Prepare your answer',body:'Write three keywords, then speak without reading a full sentence.',answer:'',hint:'Your note stays on this device.'},
      {id:'listen-self-check',label:'Listening self-check',feature:'selfcheck',title:'Summarize what you heard',body:'Say the meaning in your own words, then reveal the model summary.',answer:'The speaker is greeting someone and asking how they are.',hint:'Meaning matters more than exact wording.',mediaUrl:''}
    ],
    'language-grammar':[
      {id:'rule-reveal',label:'Rule reveal',feature:'reveal',title:'Reveal the rule',body:'When do we use “am / is / are”?',answer:'Use forms of “be” to connect a subject with a description or state.',hint:'Read the example before revealing.'},
      {id:'grammar-choice',label:'Rule choice',feature:'choice',title:'Choose the correct form',body:'She ___ a student.',options:['am','is','are'],answer:'is',hint:'Match the subject.'},
      {id:'grammar-gap',label:'Fill the gap',feature:'gap',title:'Complete the sentence',body:'They ___ ready.',answer:'are',hint:'Use the correct form of “be”.'},
      {id:'error-fix',label:'Error fixer',feature:'input',title:'Fix the error',body:'Correct: He go to school every day.',answer:'He goes to school every day.',hint:'Change only what is necessary.'},
      {id:'grammar-order',label:'Sentence order',feature:'order',title:'Order the sentence',body:'Build a correct sentence.',options:['We','are','learning','English'],answer:'We are learning English',hint:'Start with the subject.'},
      {id:'rule-multi',label:'Rule selector',feature:'multi',title:'Select correct sentences',body:'Choose every sentence that is grammatically correct.',options:['I am ready.','She are ready.','They are ready.','He is ready.'],answer:'I am ready.|They are ready.|He is ready.',hint:'There may be more than one.'},
      {id:'form-compare',label:'Form compare',feature:'compare',title:'Compare two forms',body:'Compare present simple and present continuous.',options:['I study every day.','I am studying now.'],answer:'Present simple describes routine; present continuous describes what is happening now.',hint:'Look at the time meaning.'},
      {id:'grammar-write',label:'Grammar writing',feature:'write',title:'Write with the rule',body:'Write two sentences using the current grammar rule.',answer:'',hint:'Keep the sentences short and clear.'},
      {id:'rule-sequence',label:'Rule sequence',feature:'sequence',title:'Build the rule',body:'Reveal the rule parts in order.',options:['Subject','verb','object / complement'],answer:'Subject verb object / complement',hint:'Watch the sentence structure grow.'},
      {id:'grammar-self-check',label:'Grammar self-check',feature:'selfcheck',title:'Explain the choice',body:'Explain why “She is ready” is correct.',answer:'“She” takes “is” in the present form of the verb “be”.',hint:'Name the subject and verb form.'}
    ],
    'language-examine':[
      {id:'exam-choice',label:'Single choice',feature:'choice',title:'Choose one answer',body:'Which sentence is correct?',options:['I am learning.','I learning am.','I am learn.'],answer:'I am learning.',hint:'Choose the best complete sentence.'},
      {id:'exam-multi',label:'Multiple choice',feature:'multi',title:'Select all correct answers',body:'Which sentences use “are” correctly?',options:['We are ready.','She are ready.','They are here.','I are here.'],answer:'We are ready.|They are here.',hint:'More than one answer may be correct.'},
      {id:'exam-true-false',label:'True / false',feature:'choice',title:'True or false',body:'“He is a student.” is grammatically correct.',options:['True','False'],answer:'True',hint:'Check subject–verb agreement.'},
      {id:'exam-short',label:'Short answer',feature:'input',title:'Write the answer',body:'Write the plural of “book”.',answer:'books',hint:'Type only the answer.'},
      {id:'exam-gap',label:'Gap answer',feature:'gap',title:'Complete the sentence',body:'I ___ English every day.',answer:'study',hint:'Use the present simple form.'},
      {id:'exam-order',label:'Ordering',feature:'order',title:'Put it in order',body:'Build the sentence.',options:['She','reads','every','night'],answer:'She reads every night',hint:'Tap each token in order.'},
      {id:'exam-match',label:'Meaning match',feature:'compare',title:'Match meaning and sentence',body:'Compare the prompt and response.',options:['How old are you?','I am twenty years old.'],answer:'The response correctly answers the age question.',hint:'Check whether the meanings connect.'},
      {id:'exam-sequence',label:'Reading sequence',feature:'sequence',title:'Read in parts',body:'Reveal a short passage one line at a time.',options:['Maya studies every morning.','She reviews new words.','Then she writes one sentence.'],answer:'Maya studies vocabulary and writing in the morning.',hint:'Read each line before continuing.'},
      {id:'exam-error',label:'Error identification',feature:'reveal',title:'Find the error',body:'Find the problem: “They is ready.”',answer:'“is” should be “are”.',hint:'Look at the subject.'},
      {id:'exam-response',label:'Open response',feature:'write',title:'Write a short response',body:'Write 2–3 sentences about what you learned in this box.',answer:'',hint:'Use vocabulary and grammar from this box.'}
    ]
  });
  function languageTypeList(page){return LANGUAGE_ITEM_TYPES[page]||[];}
  function languageTypeDef(page,type){const list=languageTypeList(page);return list.find(item=>item.id===type)||list[0]||null;}
  function cloneLanguageSeed(def,index){return {...JSON.parse(JSON.stringify(def)),id:'seed-'+String(def.id||'item')+'-'+(index+1),type:def.id};}
  function defaultPageItems(page){return languageTypeList(page).map((def,index)=>cloneLanguageSeed(def,index));}
  function defaultLanguageContent(selectedLanguage=targetLanguage()){
    ...
    for(const page of ['language-letters','language-voice','language-grammar','language-examine']) pages[loc+page]=defaultPageItems(page);
    pages[loc+'language-video']=[];
    return {version:2,targetLanguage:target,levels:[{id:'level-1',name:'Level 1',steps:[{id:'step-1',name:'Step 1',boxes:[{id:'box-1',name:'Box 1'}]}]}],pages,video:{[loc+'language-video']:{title:'Watch and understand',prompt:'Write what you understood from this video in your own words.',url:''}},intermediate:{
  ...
  function normalizeLanguageItem(item,page,index){
    const def=languageTypeDef(page,item?.type)||languageTypeList(page)[index%Math.max(languageTypeList(page).length,1)]||{id:'simple',label:'Content',feature:'reveal',title:'Content',body:'',answer:'',hint:''};
    return {...JSON.parse(JSON.stringify(def)),...(item&&typeof item==='object'?item:{}),id:String(item?.id||languageUid('content')),type:def.id};
  }
  function normalizeLanguageContent(value){
    ...
    content.version=2;content.pages=content.pages&&typeof content.pages==='object'?content.pages:{};content.video=content.video&&typeof content.video==='object'?content.video:{};
    Object.keys(content.pages).forEach(key=>{
      ...
      if(!languageTypeList(page).length)return;
      const source=Array.isArray(content.pages[key])?content.pages[key]:[];
      const legacySeed=source.length>0&&source.every(item=>!item?.type&&String(item?.id||'').startsWith('seed-'));
      content.pages[key]=(legacySeed?defaultPageItems(page):source.map((item,index)=>normalizeLanguageItem(item,page,index)));
    });
    return content;
  }
  ...
  function languageResponseKey(itemId){return'dafatii:language-response:'+String(window.DafatiiCourses.active().id||'none')+':'+String(itemId||'item');}
  function readLanguageResponse(itemId){try{return localStorage.getItem(languageResponseKey(itemId))||'';}catch{return'';}}
  function writeLanguageResponse(itemId,value){try{localStorage.setItem(languageResponseKey(itemId),String(value||''));}catch{}}
  function itemOptions(item){if(Array.isArray(item.options))return item.options.map(String);return String(item.options||'').split(/\n+/).map(value=>value.trim()).filter(Boolean);}
  function audioMarkup(item){const url=String(item.mediaUrl||'').trim();return url?'<div class="language-item-audio"><audio controls preload="metadata" src="'+esc(url)+'"></audio></div>':'';}
  function languageInteractiveBody(item,page){
    const feature=languageTypeDef(page,item.type)?.feature||'reveal',options=itemOptions(item),answer=String(item.answer||''),hint=String(item.hint||''),saved=readLanguageResponse(item.id),audio=page==='language-voice'?audioMarkup(item):'';
    if(feature==='flip')return audio+'<button type="button" class="language-flip-card" data-language-toggle><span class="front">'+esc(item.body||'Tap to flip')+'</span><span class="back" hidden>'+esc(answer||hint||'Back side')+'</span></button>';
    if(feature==='input'||feature==='gap')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><div class="language-answer-row"><input data-language-answer-input autocomplete="off" placeholder="'+(feature==='gap'?'Fill the missing part':'Type your answer')+'"><button type="button" data-language-check="'+esc(answer)+'">Check</button></div><div class="language-item-feedback" aria-live="polite"></div>'+(hint?'<small class="language-item-hint">'+esc(hint)+'</small>':'');
    if(feature==='choice')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><div class="language-choice-grid">'+options.map(value=>'<button type="button" data-language-choice-value="'+esc(value)+'" data-language-choice-answer="'+esc(answer)+'">'+esc(value)+'</button>').join('')+'</div><div class="language-item-feedback" aria-live="polite"></div>';
    if(feature==='multi')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><div class="language-multi-grid">'+options.map(value=>'<label><input type="checkbox" value="'+esc(value)+'" data-language-multi-option><span>'+esc(value)+'</span></label>').join('')+'</div><button type="button" class="language-inline-action" data-language-multi-check="'+esc(answer)+'">Check selections</button><div class="language-item-feedback" aria-live="polite"></div>';
    if(feature==='order')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><div class="language-token-bank">'+options.map(value=>'<button type="button" data-language-order-token="'+esc(value)+'">'+esc(value)+'</button>').join('')+'</div><div class="language-order-zone" data-language-order-zone aria-label="Built answer"></div><div class="language-inline-actions"><button type="button" data-language-order-check="'+esc(answer)+'">Check order</button><button type="button" data-language-order-reset>Reset</button></div><div class="language-item-feedback" aria-live="polite"></div>';
    if(feature==='write')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><textarea class="language-write-response" rows="6" data-language-write="'+esc(item.id)+'" placeholder="Write here…">'+esc(saved)+'</textarea><button type="button" class="language-inline-action" data-language-write-save="'+esc(item.id)+'">Save response</button><div class="language-item-feedback" aria-live="polite"></div>';
    if(feature==='sequence')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><div class="language-sequence-list">'+options.map((value,index)=>'<div data-language-sequence-part="'+index+'" '+(index?'hidden':'')+'><span>'+(index+1)+'</span><strong>'+esc(value)+'</strong></div>').join('')+'</div><button type="button" class="language-inline-action" data-language-sequence-next>Reveal next part</button>';
    if(feature==='compare')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><div class="language-compare-grid">'+options.slice(0,2).map(value=>'<div>'+esc(value)+'</div>').join('')+'</div><button type="button" class="language-inline-action" data-language-toggle>Reveal comparison</button><div class="language-reveal-panel" hidden>'+esc(answer||hint)+'</div>';
    if(feature==='selfcheck'||feature==='dialogue')return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><button type="button" class="language-inline-action" data-language-toggle>'+(feature==='dialogue'?'Reveal model turn':'Show model answer')+'</button><div class="language-reveal-panel" hidden>'+esc(answer||hint)+'</div><div class="language-self-rating"><button type="button" data-language-rate="again">Again</button><button type="button" data-language-rate="good">Good</button><button type="button" data-language-rate="easy">Easy</button></div><div class="language-item-feedback" aria-live="polite"></div>';
    if(feature==='timer'){const seconds=Math.max(5,Math.min(180,Number(answer)||20));return'<p class="language-item-prompt">'+esc(item.body||'')+'</p><div class="language-speaking-timer"><strong data-language-timer-display>'+seconds+'</strong><span>seconds</span></div><button type="button" class="language-inline-action" data-language-timer="'+seconds+'">Start speaking timer</button><div class="language-item-feedback" aria-live="polite"></div>';}
    return audio+'<p class="language-item-prompt">'+esc(item.body||'')+'</p><button type="button" class="language-inline-action" data-language-toggle>Reveal</button><div class="language-reveal-panel" hidden>'+esc(answer||hint||'Keep practicing this item.')+'</div>';
  }
  function renderLanguageLearningItem(item,page,index,total){
    const def=languageTypeDef(page,item.type)||{label:'Content'},variant=(index%10)+1;
    return '<article class="language-learning-card language-variant-'+variant+'" data-language-item="'+esc(item.id)+'" data-item-type="'+esc(item.type||'')+'"><div class="language-item-kicker"><span>'+esc(def.label)+'</span><b>'+String(index+1).padStart(2,'0')+'</b></div><h2>'+esc(item.title||'Untitled')+'</h2>'+languageInteractiveBody(item,page)+'<div class="language-item-meta"><span>'+esc(targetLanguage())+'</span><span>'+esc(item.hint||'Interactive practice')+'</span></div></article>';
  }
  function youtubeVideoId(url){const raw=String(url||'').trim();if(!raw)return'';try{const parsed=new URL(raw);if(parsed.hostname.includes('youtu.be'))return parsed.pathname.split('/').filter(Boolean)[0]||'';if(parsed.searchParams.get('v'))return parsed.searchParams.get('v');const parts=parsed.pathname.split('/').filter(Boolean);const marker=parts.findIndex(part=>['embed','shorts','live'].includes(part));return marker>=0?parts[marker+1]||'':'';}catch{return'';}}
  ...
  function languageVideoPage(){
    ...
    return '<section class="language-content-page language-video-page" data-language-content-page="language-video"><header class="language-page-head"><div><small>Level '+Math.max(1,Number(learner.currentLevel)||1)+' · Step '+Math.max(1,Number(learner.currentStep)||1)+' · Box '+Math.max(1,Number(learner.currentBox)||1)+'</small><h1>'+esc(config.title||routeTitle('language-video'))+'</h1><p>'+esc(targetLanguage())+' · watch, understand, explain</p></div></header><div class="language-video-player">'+player+'</div><article class="language-video-notes"><div><small>Your understanding</small><h2>What did you understand?</h2><p>'+esc(config.prompt||'Write the main ideas in your own words.')+'</p></div><textarea rows="9" data-language-video-note placeholder="Write what you understood from the video…">'+esc(note)+'</textarea><div class="language-video-note-actions"><span data-language-video-note-status>Private to this browser</span><button type="button" data-language-video-note-save>Save note</button></div></article></section>';
  }
  function languageContentPage(page){
    if(page==='language-video')return languageVideoPage();
    const content=readLanguageContent(),loc=currentLocation(),items=itemsFor(content,page,loc),learner=readLearnerState(),index=languagePageIndex(page,loc,items),item=items[index];
    return '<section class="language-content-page language-item-process" data-language-content-page="'+esc(page)+'"><header class="language-page-head"><div><small>Level '+Math.max(1,Number(learner.currentLevel)||1)+' · Step '+Math.max(1,Number(learner.currentStep)||1)+' · Box '+Math.max(1,Number(learner.currentBox)||1)+'</small><h1>'+esc(routeTitle(page))+'</h1><p>'+esc(targetLanguage())+' · item '+(items.length?index+1:0)+' of '+items.length+'</p></div></header><div class="language-step-progress"><span style="width:'+Math.round(((index+1)/Math.max(items.length,1))*100)+'%"></span></div>'+(item?renderLanguageLearningItem(item,page,index,items.length):'<article class="language-learning-card empty"><div class="language-item-kicker"><span>Content</span><b>00</b></div><h2>No content yet</h2><p class="language-item-prompt">Use Content Control to add an interactive item.</p></article>')+'<footer class="language-item-navigation"><button type="button" class="btn btn-ghost" data-language-item-prev '+(index===0?'disabled':'')+'>Previous</button><span>'+(items.length?index+1:0)+' / '+items.length+'</span><button type="button" class="btn btn-primary" data-language-item-next '+(!items.length||index>=items.length-1?'disabled':'')+'>Next</button></footer></section>';
  }
  ...
  function bindLanguageItemInteractions(){
    document.querySelectorAll('[data-language-toggle]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),panel=button.classList.contains('language-flip-card')?button.querySelector('.back'):card?.querySelector('.language-reveal-panel');if(!panel)return;const hidden=!panel.hasAttribute('hidden');if(hidden)panel.setAttribute('hidden','');else panel.removeAttribute('hidden');if(button.classList.contains('language-flip-card')){const front=button.querySelector('.front');if(front){if(hidden)front.removeAttribute('hidden');else front.setAttribute('hidden','');}}}));
    document.querySelectorAll('[data-language-check]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),input=card?.querySelector('[data-language-answer-input]'),feedback=card?.querySelector('.language-item-feedback'),expected=String(button.dataset.languageCheck||'').trim().toLowerCase(),actual=String(input?.value||'').trim().toLowerCase();if(feedback)feedback.textContent=actual&&actual===expected?'Correct.':'Try again.';}));
    document.querySelectorAll('[data-language-choice-value]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),feedback=card?.querySelector('.language-item-feedback'),correct=button.dataset.languageChoiceValue===button.dataset.languageChoiceAnswer;card?.querySelectorAll('[data-language-choice-value]').forEach(choice=>choice.classList.remove('is-correct','is-wrong'));button.classList.add(correct?'is-correct':'is-wrong');if(feedback)feedback.textContent=correct?'Correct.':'Try another answer.';}));
    document.querySelectorAll('[data-language-multi-check]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),selected=[...(card?.querySelectorAll('[data-language-multi-option]:checked')||[])].map(input=>input.value).sort(),expected=String(button.dataset.languageMultiCheck||'').split('|').filter(Boolean).sort(),feedback=card?.querySelector('.language-item-feedback');if(feedback)feedback.textContent=selected.length===expected.length&&selected.every((value,index)=>value===expected[index])?'Correct.':'Check the selections and try again.';}));
    document.querySelectorAll('[data-language-order-token]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),zone=card?.querySelector('[data-language-order-zone]');if(!zone||button.disabled)return;const chip=document.createElement('span');chip.textContent=button.dataset.languageOrderToken;zone.appendChild(chip);button.disabled=true;}));
    document.querySelectorAll('[data-language-order-check]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),actual=[...(card?.querySelectorAll('[data-language-order-zone] span')||[])].map(node=>node.textContent).join(' '),feedback=card?.querySelector('.language-item-feedback');if(feedback)feedback.textContent=actual===button.dataset.languageOrderCheck?'Correct order.':'Not yet. Reset and try again.';}));
    document.querySelectorAll('[data-language-order-reset]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),zone=card?.querySelector('[data-language-order-zone]');if(zone)zone.innerHTML='';card?.querySelectorAll('[data-language-order-token]').forEach(token=>token.disabled=false);const feedback=card?.querySelector('.language-item-feedback');if(feedback)feedback.textContent='';}));
    document.querySelectorAll('[data-language-write-save]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),area=card?.querySelector('[data-language-write]'),feedback=card?.querySelector('.language-item-feedback');writeLanguageResponse(button.dataset.languageWriteSave,area?.value||'');if(feedback)feedback.textContent='Saved.';}));
    document.querySelectorAll('[data-language-sequence-next]').forEach(button=>button.addEventListener('click',()=>{const card=button.closest('.language-learning-card'),parts=[...(card?.querySelectorAll('[data-language-sequence-part]')||[])],next=parts.find(part=>part.hasAttribute('hidden'));if(next)next.removeAttribute('hidden');if(!parts.some(part=>part.hasAttribute('hidden')))button.disabled=true;}));
    document.querySelectorAll('[data-language-rate]').forEach(button=>button.addEventListener('click',()=>{const feedback=button.closest('.language-learning-card')?.querySelector('.language-item-feedback');if(feedback)feedback.textContent='Marked: '+button.dataset.languageRate+'.';}));
    document.querySelectorAll('[data-language-timer]').forEach(button=>button.addEventListener('click',()=>{if(button.dataset.running==='1')return;button.dataset.running='1';const card=button.closest('.language-learning-card'),display=card?.querySelector('[data-language-timer-display]'),feedback=card?.querySelector('.language-item-feedback');let remaining=Math.max(1,Number(button.dataset.languageTimer)||20);button.disabled=true;const timer=setInterval(()=>{remaining--;if(display)display.textContent=remaining;if(remaining<=0){clearInterval(timer);button.disabled=false;button.dataset.running='0';if(feedback)feedback.textContent='Time. Finish your last sentence.';}},1000);}));
  }
  function bindLanguagePage(page){
    ...
    if(page==='language-video'){document.querySelector('[data-language-video-note-save]')?.addEventListener('click',()=>{const area=document.querySelector('[data-language-video-note]'),status=document.querySelector('[data-language-video-note-status]');try{localStorage.setItem(languageVideoNoteKey(currentLocation()),area?.value||'');if(status)status.textContent='Saved on this device';}catch{if(status)status.textContent='Could not save this note';}});return;}
    if(LANGUAGE_ROUTES.includes(page)&&page!=='language-home'){const content=readLanguageContent(),loc=currentLocation(),items=itemsFor(content,page,loc),index=languagePageIndex(page,loc,items);document.querySelector('[data-language-item-prev]')?.addEventListener('click',()=>{setLanguagePageIndex(page,loc,index-1);render();});document.querySelector('[data-language-item-next]')?.addEventListener('click',()=>{setLanguagePageIndex(page,loc,index+1);render();});bindLanguageItemInteractions();return;}
    ...
    const advance=()=>{const state=readLearnerState();writeLearnerState({intermediateIndex:(Number(state.intermediateIndex)||0)+1});render();};
    document.querySelector('[data-language-step-next]')?.addEventListener('click',advance);
  ...
  function accessLanguageContent(originPage,page,loc,itemId){
    ...
    writeLearnerState({currentLevel:level,currentStep:step,currentBox:box});setLanguagePageIndex(page,loc,index);hideLanguageControl(originPage);if(originPage!==page)setHash(page);else render();
  }
  ...
  async function importLanguageFiles(files,page){const result=[];const fallback=languageTypeDef(page,languageTypeList(page)[0]?.id);for(const file of [...files].slice(0,12)){const name=String(file.name||'Imported file'),lower=name.toLowerCase();if(/\.(xlsx|xls|csv)$/.test(lower)&&window.XLSX){const workbook=window.XLSX.read(await file.arrayBuffer(),{type:'array'}),sheet=workbook.Sheets[workbook.SheetNames[0]],rows=window.XLSX.utils.sheet_to_json(sheet,{header:1,blankrows:false});rows.slice(0,80).forEach((row,index)=>{const values=(Array.isArray(row)?row:[row]).map(value=>String(value??'').trim()).filter(Boolean);if(values.length)result.push({...(fallback?JSON.parse(JSON.stringify(fallback)):{}),id:languageUid('import'),type:fallback?.id||'',title:values[0]||('Row '+(index+1)),body:values.slice(1).join(' · ')});});}else if(lower.endsWith('.zip')&&window.JSZip){const zip=await window.JSZip.loadAsync(await file.arrayBuffer());Object.values(zip.files).filter(entry=>!entry.dir).slice(0,80).forEach(entry=>result.push({...(fallback?JSON.parse(JSON.stringify(fallback)):{}),id:languageUid('import'),type:fallback?.id||'',title:entry.name,body:'Imported from ZIP package.'}));}else result.push({...(fallback?JSON.parse(JSON.stringify(fallback)):{}),id:languageUid('import'),type:fallback?.id||'',title:name,body:'Imported file reference.'});}return result;}
  function languageTypeOptions(page,selected=''){return languageTypeList(page).map(def=>'<option value="'+esc(def.id)+'" '+(def.id===selected?'selected':'')+'>'+esc(def.label)+'</option>').join('');}
  function languageEditorFields(page,item={}){
    const types=languageTypeList(page),options=Array.isArray(item.options)?item.options.join('\n'):String(item.options||''),choices=Array.isArray(item.choices)?item.choices.join('\n'):'';
    return (types.length?'<div class="field"><label>Item type</label><select name="type">'+languageTypeOptions(page,item.type||types[0]?.id)+'</select></div>':'')+'<div class="field"><label>Title</label><input name="title" maxlength="120" value="'+esc(item.title||'')+'" placeholder="Item title"></div><div class="field"><label>Instruction / text</label><textarea name="body" rows="4" maxlength="1600">'+esc(item.body||'')+'</textarea></div>'+(types.length?'<div class="field"><label>Answer / model response</label><textarea name="answer" rows="3" maxlength="1000">'+esc(item.answer||'')+'</textarea></div><div class="field"><label>Options — one per line</label><textarea name="options" rows="4" maxlength="1600">'+esc(options)+'</textarea></div><div class="field"><label>Hint</label><input name="hint" maxlength="240" value="'+esc(item.hint||'')+'"></div><div class="field"><label>Audio URL — optional</label><input name="mediaUrl" type="url" maxlength="900" value="'+esc(item.mediaUrl||'')+'" placeholder="https://…"></div>':'<div class="field"><label>Choices — one per line</label><textarea name="choices" rows="4" maxlength="1200">'+esc(choices)+'</textarea></div>');
  }
  function readLanguageEditorData(form,page,base={}){
    const data=Object.fromEntries(new FormData(form)),type=String(data.type||base.type||''),def=languageTypeDef(page,type),next={...(def?JSON.parse(JSON.stringify(def)):{}),...base,type:def?.id||type,title:String(data.title||'').trim()||'Untitled',body:String(data.body||'').trim()};
    if(languageTypeList(page).length){next.answer=String(data.answer||'').trim();next.options=String(data.options||'').split(/\n+/).map(value=>value.trim()).filter(Boolean);next.hint=String(data.hint||'').trim();next.mediaUrl=String(data.mediaUrl||'').trim();}else next.choices=String(data.choices||'').split(/\n+/).map(value=>value.trim()).filter(Boolean);
    return next;
  }
  function renderLanguageImportStep(originPage,page,loc,target,close){
    ...
    sheet.insertAdjacentHTML('beforeend','<form class="language-control-step language-item-editor" data-language-add-form><small>Step 3 of 3</small><h3>Add an interactive content item</h3>'+languageEditorFields(page,{type:languageTypeList(page)[0]?.id||'',title:'',body:''})+'<div class="field"><label>Excel or ZIP files</label><input data-language-import-files type="file" accept=".xlsx,.xls,.csv,.zip" multiple></div><p class="auth-note">Excel rows and ZIP entries use the first item type for this page. You can edit them afterward.</p><div class="language-control-footer"><button type="button" class="btn btn-ghost" data-language-import-cancel>Cancel</button><button type="submit" class="btn btn-primary">Add</button></div><p class="auth-note" data-language-import-status></p></form>');
    const step=sheet.querySelector('[data-language-add-form]');step.querySelector('[data-language-import-cancel]').onclick=close;
    step.onsubmit=async event=>{event.preventDefault();const status=step.querySelector('[data-language-import-status]'),button=step.querySelector('button[type=submit]');button.disabled=true;status.textContent='Adding…';try{const content=readLanguageContent();let destination={...loc};if(!LANGUAGE_INTERMEDIATE_ROUTES.includes(page)&&target!=='language'){if(target==='level'){const number=(content.levels?.length||0)+1,newLevel={id:'level-'+number,name:'Level '+number,steps:[{id:'step-1',name:'Step 1',boxes:[{id:'box-1',name:'Box 1'}]}]};content.levels.push(newLevel);destination={level:newLevel.id,step:'step-1',box:'box-1'};}else{const level=content.levels.find(item=>item.id===loc.level)||content.levels[0];if(target==='step'){const number=(level.steps?.length||0)+1,newStep={id:'step-'+number,name:'Step '+number,boxes:[{id:'box-1',name:'Box 1'}]};level.steps.push(newStep);destination={level:level.id,step:newStep.id,box:'box-1'};}if(target==='box'){const stepObj=(level.steps||[]).find(item=>item.id===loc.step)||level.steps?.[0],number=(stepObj.boxes?.length||0)+1,newBox={id:'box-'+number,name:'Box '+number};stepObj.boxes.push(newBox);destination={level:level.id,step:stepObj.id,box:newBox.id};}}}
      const draft=readLanguageEditorData(step,page,{id:languageUid('content')}),imported=await importLanguageFiles(step.querySelector('[data-language-import-files]').files||[],page),hasDraft=Boolean(draft.title!=='Untitled'||draft.body||draft.answer||(draft.options||[]).length),additions=[...imported];if(hasDraft||!imported.length)additions.unshift(draft);
  ...
  function openLanguageItemEditor(originPage,page,loc,itemId){
    ...
    const close=languageControlSheet('Edit content','<form class="language-item-editor" data-language-edit-form>'+languageEditorFields(page,item)+'<div class="language-editor-actions"><button class="btn btn-primary" type="submit">Save changes</button><button class="btn btn-ghost danger" type="button" data-language-delete-item>Delete item</button></div><p class="auth-note" data-language-edit-status>Deleting is available only inside this edit form.</p></form>');
    const form=document.querySelector('[data-language-edit-form]');
    form.onsubmit=event=>{event.preventDefault();const updated=readLanguageEditorData(form,page,item);Object.assign(item,updated);writeLanguageContent(content);hideLanguageControl(originPage);close();render();};
